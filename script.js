...
const createNewTransaction = () => {
    ...
    <button class="delete" onclick="deleteTransaction(${ID})"><i class="fa-solid fa-square-xmark"></i></button>
    </p>    
    `;
	...
	amountInput.value > 0
		...
		: expensesSection.appendChild(newTransaction) &&
		  newTransaction.classList.add("expence");
...
const checkCategory = (transaction) => {
	switch (transaction) {
		...
		case "[ - ] Food":
			...
			break;
		case "[ - ] Cinema":
			categoryIcon = '<i class="fa-solid fa-film">';
			break;
		case "[ - ] Sport":
			categoryIcon = '<i class="fa-solid fa-bicycle"></i>';
			break;
	}
};
